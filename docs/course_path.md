...
- `projects/jaffle_platform/models/marts/fct_orders.sql`
- `projects/jaffle_platform/models/marts/fct_order_items.sql`
- `projects/jaffle_finance/models/marts/fct_order_revenue.sql`
- `projects/jaffle_finance/models/marts/_marts.yml`
...
- Pick one merchandising or planning mart and decide whether it should be
...
- Add a singular test for overlapping capacity scenario windows.
...
> analysis that connects merchandising availability with finance revenue quality.
...
| Public model access | `projects/*/models/marts/_*.yml` |
| Model contracts | `projects/*/models/marts/_*.yml` |
...
| Exposures | `projects/*/models/**/_*.yml` |
