...
select
    {{ jaffle_shared.scenario_component_store_week_key('plans.scenario_name', 'plans.component_id', 'plans.store_id', 'plans.plan_week_start_utc') }} as component_week_plan_variance_key,
    plans.plan_id,
    plans.store_id,
    plans.component_id,
