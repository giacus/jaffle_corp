...
select
    {{ shared.stable_hash(['payment_allocations.order_id', 'payment_allocations.ordered_date_utc']) }}
    ...
    payment_allocations.captured_amount_usd - payment_allocations.refunded_amount_usd
        as net_revenue_usd,
    {{ shared.minor_units_to_major_units('payment_allocations.tax_minor') }}
        as tax_amount_major,
    {{ shared.minor_units_to_major_units('payment_allocations.discount_minor') }}
        as discount_amount_major,
    {{ shared.minor_units_to_major_units('payment_allocations.service_fee_minor') }}
