select
    ...
    {{ shared.normalize_ticket_issue('issue_type') }} as normalized_issue_type,
    ...
    {{ shared.minor_units_to_major_units('concession_minor') }} as concession_major,
    cast(currency as varchar) as currency,
    {{ shared.minutes_between(
        'opened_at_utc',
...
from {{ source('experience_app', 'raw_support_tickets') }}
