select
    ...
    {{ shared.normalize_payment_status('payment_status') }} as payment_status,
    ...
    {{ shared.minor_units_to_major_units('amount_minor') }} as amount_major,
    cast(currency as varchar) as currency,
    cast(processor_region as varchar) as processor_region,
    cast(updated_at_utc as timestamp) as updated_at_utc
from {{ source('platform_app', 'raw_payments') }}
