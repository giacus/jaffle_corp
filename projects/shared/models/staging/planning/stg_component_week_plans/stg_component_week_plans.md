...
{% docs shared__stg_component_week_plans__plan_id %}
...
{% docs shared__stg_component_week_plans__planned_receipt_quantity %}
Quantity of planned receipt recorded by the source.
{% enddocs %}

{% docs shared__stg_component_week_plans__planned_usage_quantity %}
Quantity of planned usage recorded by the source.
{% enddocs %}

{% docs shared__stg_component_week_plans__planned_waste_quantity %}
