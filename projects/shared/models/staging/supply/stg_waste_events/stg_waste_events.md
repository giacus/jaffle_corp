{% docs jaffle_supply__stg_waste_events %}
...
{% docs shared__stg_waste_events__store_id %}
Source-system identifier for the store or operating location.
{% enddocs %}

{% docs shared__stg_waste_events__component_id %}
Source-system identifier for the component.
{% enddocs %}

{% docs shared__stg_waste_events__product_id %}
Source-system identifier for the sellable product.
{% enddocs %}

{% docs shared__stg_waste_events__order_id %}
...
{% docs shared__stg_waste_events__unit %}
