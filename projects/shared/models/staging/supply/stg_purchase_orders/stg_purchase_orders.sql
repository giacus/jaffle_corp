select
    ...
    {{ shared.normalize_po_status('status') }} as purchase_order_status,
    ...
    {{ shared.minor_units_to_major_units('unit_cost_minor') }} as unit_cost_major,
    cast(currency as varchar) as currency,
    cast(updated_at_utc as timestamp) as updated_at_utc
from {{ source('supply_app', 'raw_purchase_orders') }}
